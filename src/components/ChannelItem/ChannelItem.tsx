...
const ChannelItemWrapper = styled(Box)<BoxProps & { selected: boolean }>((props) => ({
...
const ChannelItemContent = styled(Box)<BoxProps>(() => ({
...
const ChannelItemText = styled(Typography)<TypographyProps>(() => ({
  fontSize: '1rem',
  fontWeight: 500,
  color: '#D1D2D3',
  textTransform: 'uppercase',
